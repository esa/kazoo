...
cd "$SKELS" && rm -f livesinx86.zip && zip livesinx86 livesinx86/* && cd $OLDPWD

cd "$SKELS" && rm -f livesingr740.zip && zip livesingr740 livesingr740/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subC livesinx86:"$SKELS"/livesinx86.zip \
	--subC livesingr740:"$SKELS"/livesingr740.zip \
